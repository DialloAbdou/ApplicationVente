...
namespace WebApplicationVente.Repository
{
    public class MookProduitRepository : IProduitRepository
    {
        ...
        public IEnumerable<Produit> GetAllProduits()
        {
            ...
            {
            new Produit{ProduitId=1,NomProduit ="Tomate",PrixVentHT = 1.5, Tva= 0.5, PrixVenteTTC = 1.15,
            ...
            new Produit{ProduitId=2,NomProduit ="Aubergine",PrixVentHT = 2.1, Tva= 0.05, PrixVenteTTC = 2.20,
            ...
            new Produit{ProduitId=3,NomProduit ="Carotte",PrixVentHT = 1.1, Tva= 0.05, PrixVenteTTC = 1.15,
            ...
            new Produit{ProduitId=4,NomProduit ="Pomme",PrixVentHT = 2, Tva= 0.05, PrixVenteTTC = 2.05,
            ImageUrl="https://media.gerbeaud.net/2017/01/640/pomme-detouree.jpg", CategorieId = 2, Categorie = _category.GetCategorie(2)},

            new Produit{ProduitId=5,NomProduit ="Orange",PrixVentHT = 2, Tva= 0.05, PrixVenteTTC = 2.05,
            ...
            new Produit{ProduitId=5,NomProduit ="lait",PrixVentHT = 1, Tva= 0.05, PrixVenteTTC = 1.05,
